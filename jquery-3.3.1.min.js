...
("undefined" != typeof window ? window:this, function(e,t) {
	...
	w.extend({
		expando: "jQuery" + ("3.3.1" + Math.random()).replace(/\D/g, ""), isReady: !0,
		error: function(e) {
			throw new Error(e)
		},
		noop: function(){},
	...
	var E = function(e) {
		var t, n, r, i, o, a, s, u, l, c, f, p, d, h, g, y, v, m, x, b = "sizzle" + 1*new Date, w = e.document, T = 0, C = 0, E = ae(), k = ae(), S = ae(), D = function(e,t) {
			...
			p = oe.setDocument = function(e) {
				...
				return a !== d && 9 === a.nodeType && a.documentElement ? (d = a, h = d.documentElement, g =! o(d), w !== d && (i = d.defaultView) && i.top !== i && (i.addEventListener ? i.addEventListener("unload", re, !1):i.attachEvent && i.attachEvent("onunload", re)),
				...
				t = Q.test(h.compareDocumentPosition), x = t || Q.test(h.contains) ? function(e,t) {
					...
					while (a[r] === s[r])
						r++;
					return r ? ce(a[r], s[r]):a[r] === w ? -1:s[r] === w?1:0}, d):d
			},
			...
			(r = oe.selectors = {
				cacheLength:50, createPseudo:se, match:V, attrHandle:{}, find:{}, relative:{">":{
			...
			function ye() {} ye.prototype = r.filters = r.pseudos, r.setFilters = new ye, a = oe.tokenize = function(e,t) {
				...
				if (c)
					return t ? 0:c.slice(0); s = e, u = [], l = r.preFilter;
				while (s) {
	...
	var z = function(e,t,n,r,i,o,a) {
		...
		if ("object" === x(n)) {
			...
			we = /^key/, Te = /^(?:mouse|pointer|contextmenu|drag|drop)|click/,
			Ce = /^([^.]*)(?:\.(.+)|)/;function Ee() {
				return !0
			}
			function ke() {
					...
					if (!(h.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || w.isXMLDoc(e)))
						...
						if (t)
							if (n)
								...
								Pe(e, s); return(a = ye(s, "script")).length > 0 && ve(a, !u && ye(e, "script")), s
				},
			...
			!function() {
				function t() {
					if (c) {
						...
						c.style.right = "60%", s = 36 === n(t.right), o = 36 === n(t.width),
			...
			function pt(e,t,n) {
				...
				u = function() {
					...
					for (var t = nt || st(), n = Math.max(0, l.startTime + l.duration - t), r = 1 - (n / l.duration || 0), o = 0, a = l.tweens.length; o < a; o++)
						l.tweens[o].run(r);
					return s.notifyWith(e, [l, r, n]), r < 1 && a ? n:(a || s.notifyWith(e, [l, 1, 0]), s.resolveWith(e, [l]), !1)}, l = s.promise({
						elem: e,
						props: w.extend({}, t),
						opts: w.extend(!0, {
							specialEasing: {},
			...
			w.fn.extend({
				...
				finish: function(e) {
					return !1 !== e && (e = e || "fx"), this.each(function() {
						...
						o = w.timers,
						a = r ? r.length:0;
						for (n.finish = !0, w.queue(this, e, []), i && i.stope && i.stop.call(this, !0), t = o.length; t--;)
			...
			w.each(
				w.expr.match.bool.source.match(/\w+/g), function(e,t) {
			...
			w.extend({
				...
				ajax: function(t,n) {
					...
					h.ifModified && (
						w.lastModified[o] && E.setRequestHeader("If-Modified-Since",
						w.lastModified[o]),
						w.etag[o] && E.setRequestHeader("If-None-Match",
						w.etag[o])
					),(h.data && h.hasContent && !1 !== h.contentType || n.contentType) && E.setRequestHeader("Content-Type", h.contentType), E.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + $t + "; q=0.01":""):h.accepts["*"]);
					for (p in h.headers)
					...
					function k(t,n,r,s) {
						...
						c || (
							...
							204 === t || "HEAD" === h.type ? C = "nocontent":304 === t ? C = "notmodified":(C = b.state, p = b.data, l = !(d = b.error))):(d = C, !t && C || (C = "error", t < 0 && (t = 0))),
							E.status = t,
							E.statusText = (n || C) + "",
			...
			h.ajax = Gt = !!Gt, w.ajaxTransport(function(t) {
				var n, r;
								...
								n = function(e) {
									return function() {
										n && (
											...
											s.statusText, "text" !== (s.responseType || "text") || "string" != typeof s.responseText ? {binary: s.response}:{text:s.responseText}, s.getAllResponseHeaders())
										)
									}
			...
			w.each(
				["ajaxStart", "ajaxStop", "ajaxComplete", "ajaxError", "ajaxSuccess", "ajaxSend"], function(e,t) {
					w.fn[t] = function(e) {
						return this.on(t, e)
					}
				}
			...
			w.each(
				"blur focus focusin focusout resize scroll click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup contextmenu".split(" "), function(e,t) {
					w.fn[t] = function(e,n) {
